<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"D:\wamp\www\my_blog\public/../application/admin\view\overview\year.html";i:1524752596;s:28:"static/model/admin_head.html";i:1524829678;s:27:"static/model/admin_nav.html";i:1524831623;s:38:"static/model/admin_calendar_input.html";i:1524227965;}*/ ?>
<!DOCTYPE html>
<html lang="ch">
<head>
    <meta charset="UTF-8">
                ...
                <div class="panel panel-default">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <a href="/admin/overview/more_click_posts.html?type=year&date=<?php echo $date; ?>" style="float: right;;margin-right: 15px;">
                        ...
                        <li class="list-group-item">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <a href="/admin/overview/more_visit_records.html?type=year&date=<?php echo $date; ?>" style="float: right;margin-right: 15px;">
                                        <span class="glyphicon glyphicon-triangle-bottom" aria-hidden="true"></span>更多
                                    </a>
                                </div>
                            </div>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <span class="glyphicon glyphicon-calendar"></span>
                                            <a href="/admin/overview/year.html?date=<?php echo $recent_date; ?>"><?php echo $recent_date; ?></a>
                                        </td>
                                    </tr>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </tbody>
